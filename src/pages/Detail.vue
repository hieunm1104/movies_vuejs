  ...
  methods: {
    async getMovieDetail() {
      ...
      try {
        ...
        this.movie = data;
        console.log("array movie: ", this.movie);
        const resTrailer = await Trailer(`${this.movie.Title}`).get();
        this.trailerID = resTrailer.data.items[0].id.videoId;
      } catch (error) {
        console.log(error);
      } finally {
